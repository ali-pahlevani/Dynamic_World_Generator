...
motions = {}
states = {}
motions["box_1"] = {'type': 'linear', 'velocity': 10.0, 'std': 0.1, 'path': [(-0.1, -1.0), (-2.3, 1.9)]}
states["box_1"] = {'current_pos': [-0.1, -1.0], 'direction': 1, 'start': [-0.1, -1.0], 'end': [-2.3, 1.9], 'z': 0.5}
motions["box_2"] = {'type': 'elliptical', 'velocity': 1.0, 'std': 0.1, 'semi_major': 1.0, 'semi_minor': 0.5, 'angle': -3.141592653589793}
states["box_2"] = {'theta': 0.0, 'center': [3.9, -0.6], 'semi_major': 1.0, 'semi_minor': 0.5, 'angle': -3.141592653589793, 'z': 0.5}
