...
motions = {}
states = {}
motions["box_2"] = {'type': 'linear', 'velocity': 10.0, 'std': 0.1, 'path': [(0.6, -0.3), (5.2, 0.6)]}
states["box_2"] = {'current_pos': [0.6, -0.3], 'direction': 1, 'start': [0.6, -0.3], 'end': [5.2, 0.6], 'z': 0.5}
motions["cylinder_1"] = {'type': 'elliptical', 'velocity': 1.0, 'std': 0.1, 'semi_major': 2.0, 'semi_minor': 1.0, 'angle': -2.5308666892005847}
states["cylinder_1"] = {'theta': 0.0, 'center': [0.8, -1.8], 'semi_major': 2.0, 'semi_minor': 1.0, 'angle': -2.5308666892005847, 'z': 0.5}
