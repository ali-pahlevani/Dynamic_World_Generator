...
motions = {}
states = {}
motions["box_1"] = {'type': 'polygon', 'velocity': 5.0, 'std': 0.1, 'path': [(-23.9, -15.0), (-23.4, -9.3), (-19.5, -8.7), (-15.5, -11.6), (-15.2, -16.2), (-18.7, -20.0), (-23.9, -19.3)]}
states["box_1"] = {'current_segment': 0, 't': 0.0, 'path': [[-23.9, -15.0], [-23.4, -9.3], [-19.5, -8.7], [-15.5, -11.6], [-15.2, -16.2], [-18.7, -20.0], [-23.9, -19.3]], 'z': 0.5}
motions["sphere_2"] = {'type': 'linear', 'velocity': 8.0, 'std': 0.1, 'path': [(5.7, -22.2), (21.8, -13.6)]}
states["sphere_2"] = {'current_pos': [5.7, -22.2], 'direction': 1, 'start': [5.7, -22.2], 'end': [21.8, -13.6], 'z': 2.0}
motions["cylinder_3"] = {'type': 'elliptical', 'velocity': 3.5, 'std': 0.1, 'semi_major': 4.0, 'semi_minor': 0.7, 'angle': 0.1163551652068748}
states["cylinder_3"] = {'theta': 0.0, 'center': [5.3, 0.6], 'semi_major': 4.0, 'semi_minor': 0.7, 'angle': 0.1163551652068748, 'z': 1.0}
motions["cylinder_5"] = {'type': 'linear', 'velocity': 3.0, 'std': 0.1, 'path': [(-1.2, 22.7), (18.2, 22.8)]}
states["cylinder_5"] = {'current_pos': [-1.2, 22.7], 'direction': 1, 'start': [-1.2, 22.7], 'end': [18.2, 22.8], 'z': 1.5}
