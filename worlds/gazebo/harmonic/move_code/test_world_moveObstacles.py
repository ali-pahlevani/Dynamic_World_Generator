...
motions = {}
states = {}
motions["box_1"] = {'type': 'polygon', 'velocity': 3.0, 'std': 0.1, 'path': [(-5.5, 0.5), (-3.9, 2.3), (-1.9, 1.0), (-1.6, -1.1), (-3.2, -0.9), (-4.7, -1.4), (-6.4, -0.6)]}
states["box_1"] = {'current_segment': 0, 't': 0.0, 'path': [[-5.5, 0.5], [-3.9, 2.3], [-1.9, 1.0], [-1.6, -1.1], [-3.2, -0.9], [-4.7, -1.4], [-6.4, -0.6]], 'z': 0.25}
motions["cylinder_1"] = {'type': 'elliptical', 'velocity': 2.0, 'std': 0.1, 'semi_major': 2.0, 'semi_minor': 0.5, 'angle': 0.785398163397448}
states["cylinder_1"] = {'theta': 0.0, 'center': [8.7, -10.7], 'semi_major': 2.0, 'semi_minor': 0.5, 'angle': 0.785398163397448, 'z': 0.75}
motions["sphere_1"] = {'type': 'linear', 'velocity': 4.0, 'std': 0.1, 'path': [(20.9, -13.2), (13.9, -13.4)]}
states["sphere_1"] = {'current_pos': [20.9, -13.2], 'direction': 1, 'start': [20.9, -13.2], 'end': [13.9, -13.4], 'z': 1.2}
